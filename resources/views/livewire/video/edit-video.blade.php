                ...
                <div class="bg-brown text-white px-4 py-4">
                    <form wire:submit.prevent="save" enctype="multipart/form-data">
                            ...
                            <div class="w-12/12 md:w-3/12">
                                ...
                                <div class="max-w-xs mx-auto my-4">
                                    ...
                                    @elseif($videoFile !== null)
                                        <span>Добавлен видео файл</span>
                                    @else
                                        <span>Изменить файл видео</span>
                                    @endif
                                    <div wire:loading wire:target="videoFile">
                                        <div id="overlay" x-show="!$wire.videoFile">
                        ...
                        <div class="flex flex-row flex-auto">
                            ...
                            <livewire:components.option.using-condition :message="$video" :classes="$classes"/>
                        </div>
                ...
                <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                        <div class="shadow overflow-hidden bg-white p-4">
                            @if($video->transitions->isNotEmpty())
                                @foreach($video->transitions as $key=>$transition)
