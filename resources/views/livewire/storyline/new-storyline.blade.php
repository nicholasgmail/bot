<div>
            ...
            <div class="overflow-hidden shadow-xl sm:rounded-lg">
                <div class="bg-brown text-white px-4 py-4">
                    <div class="max-w-xs mx-auto">
                        <input wire:model="name" class="{{$classes}}" placeholder="Сюжет">
                    ...
                    <div class="text-center mt-4">
                        <button wire:click="addStoryline"
                                type="button"
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 pt-4 ">
        <div class="flex-initial w-1/3 mb-4">
                                ...
                                @foreach($allStoryline as $item)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="#" wire:click.prevent="copyStoryline({{$item->id}})"  class="text-blue-600 hover:text-red-900">Копировать</a>
                                            <span>|</span>
                                            <a href="{{route('storyline_edit', $item->id)}}" class="text-green-600 hover:text-green-900">Редактировать</a>
                                            <span>|</span>
                                            <a href="#" wire:click.prevent="removeStoryline({{$item->id}})"  class="text-red-600 hover:text-red-900">Удалить</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
