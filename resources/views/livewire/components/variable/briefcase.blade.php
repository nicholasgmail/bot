<div>
    ...
    <div class="flex flex-row flex-wrap justify-start text-sm">
        ...
        <div class="w-2/5 border border-white p-2 mt-3">
            <h5>{{ __("Кредит вывод через цикл") }}</h5>
        ...
        <div class="w-2/5 border border-white p-2 mt-3">
            <h5>{{ __("Актив вывод через цикл") }}</h5>
        ...
        <div class="w-2/5 border border-white p-2 mt-3">
            <h5>{{ __("Пасив вывод через цикл") }}</h5>
        ...
        <div class="w-2/5 border border-white p-2 mt-3">
            <h5>{{ __("Доход вывод через цикл") }}</h5>
