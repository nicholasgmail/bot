<div>
                        ...
                        <div class="flex flex-row flex-wrap gap-6">
                            <div class="flex-initial w-full md:w-5/12">
                                <div class="inline-block pt-2 mb-4">
                                    ...
                                    <input wire:model.lazy="title" id="title" name="title" type="text" required
                                ...
                                <textarea wire:model.lazy="caption" name="caption" rows="9" class="{{$classes}}"
                            ...
                            <div class="flex-shrink w-full md:w-64">
                                <img class="max-w-full m-auto block" src="{{$image->url}}" style="height: auto"
                                     alt="картинка">
                        ...
                        <div class="flex flex-row flex-auto">
                            <div class="w-full md:w-5/12">
                                <div class="flex flex-col sm:flex-row gap-4">
                                    ...
                                    {{--<div class="flex-inline pt-2">
                                        <label for="priority">Вес рандома</label>
                                        <input wire:model="whole_random" type="text" required
                                               class="relative block w-full px-3 py-2 border
                                        border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none
                                        focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
                                               placeholder="1" value="1">
                            ...
                            <livewire:components.option.using-condition :message="$image" :classes="$classes"/>
                        </div>
                ...
                <div class="my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="py-2 align-middle inline-block min-w-full sm:px-6 ">
                        <div class="shadow overflow-hidden bg-white p-4">
                            ...
                            @forelse($image->transitions as $key=>$transition)
    ...
    @if($isOpenWhere)
        <x-modal.info wire:model="isOpenWhere" maxWidth="2xl">
            ...
            <x-slot name="content">
                <div class="flex flex-col md:flex-row flex-wrap gap-2 sm:gap-6 p-4">
                    <div class="flex-1">
