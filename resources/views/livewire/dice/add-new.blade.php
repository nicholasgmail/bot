                ...
                <div class="bg-brown text-white px-4 py-4">
                    <form wire:submit.prevent="save">
                        <div class="max-w-xs mx-auto">
                            <input wire:model.lazy="title" class="{{$classes}}" placeholder="Кости">

                            @if($errors->has('title'))
                                @error('title') <span class="font-bold text-red-500">{{ $message }}</span> @enderror
                            @else
                                <span>Название набора от 3 до 64 символов</span>
                            @endif
                        </div>
